...
const deliverables = [
  {
    ...
    items: [
      ...
      "Problem identification and importance",
...
const HackathonChallenges: React.FC = () => {
    ...
    <section className="relative overflow-hidden py-20">
      ...
      <div className="container relative space-y-12">
        <div className="mx-auto max-w-3xl space-y-6 text-center">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Participants are required to design and present an innovative idea for a smart application that integrates one or more cutting-edge technologies (artificial intelligence, blockchain, IoT, etc.), under one of the following two themes:
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <Button asChild>
            <Link to="https://forms.gle/VBfT6vzRbQED9DYu7">Submit Your Challenge</Link>
          </Button>
        </div>
